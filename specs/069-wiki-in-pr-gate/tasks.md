...
- [x] T008 [US3] Constitution Principle IV amendment via `speckit-constitution` (MINOR bump to v1.2.0, Sync Impact Report) — ORCHESTRATOR task, committed onto the task branch, in `.specify/memory/constitution.md` (spec FR-008)
...
- [x] T010 Post-merge (root): spec-bridge sync, tasks.md ticks, runbook execution-log row — derived state only, per the very doctrine this spec lands
