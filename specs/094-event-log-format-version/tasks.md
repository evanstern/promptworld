...
- [ ] T007 Remove TASK-121's chronicle Type-column display-alias shim; chronicle
  renders guardian.* natively (US3.3).
- [ ] T008 End-to-end: seeded pre-rename world → migrate → byte-identical replay →
