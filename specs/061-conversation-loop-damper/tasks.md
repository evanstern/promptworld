...
- [ ] T001 [US2] `PairTalks` on `sim.State` (sorted slice, A<B invariant,
...
- [ ] T002 [P] [US2] Tests: record updates on both hail-founded and ambient
...
- [ ] T003 [US1] Pair-cooldown check in `hailable()`
      ...
      planner sees.
- [ ] T004 [P] [US1] Tests: the world-01 loop shape — hail-founded talk →
      ...
      vacuous (SC-001).
- [ ] T005 [P] [US1] Regression pins: ambient-beat gate (`canTalk`) and
...
- [ ] T006 [US3] Novelty gate at mind scene founding
