...
board-sweep-2026-07-29 lane 5: spec 100 authored from the card's pre-session decisions + spec-012 pins; invariants I1-I5, decisions D1-D5, solved calibration worksheet (AC2). Ratification PR follows; operator review ratifies.
<!-- SECTION:NOTES:END -->
