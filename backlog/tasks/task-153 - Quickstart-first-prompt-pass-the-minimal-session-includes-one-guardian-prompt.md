...
- [ ] #3 Spec phase: Setup & baseline
- [ ] #4 Spec phase: Foundational — the editorial contract (blocks all page edits)
- [ ] #5 Spec phase: User Story 1 — getting-started first-prompt step (board AC #1) 🎯
- [ ] #6 Spec phase: User Story 2 — stage-page first-session blocks (board AC #2)
- [ ] #7 Spec phase: Gates & polish
<!-- AC:END -->
