...
- [ ] #7 Spec phase: User Story 1 — A code PR cannot open without its wiki grounding (P1)
- [ ] #8 Spec phase: User Story 2 — Player docs cannot go stale through a merge (P1)
- [ ] #9 Spec phase: User Story 3 — The doctrine says what the gate enforces (P2)
