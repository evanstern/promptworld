...
- [ ] #4 Spec phase: Setup
- [ ] #5 Spec phase: Foundational — derived state, class dictionary, reducer arms (blocks all)
- [ ] #6 Spec phase: User Story 1 — the deterministic percept + high-salience memory (P1, board AC #2)
- [ ] #7 Spec phase: User Story 2 — validated against Oak's death window, silent on healthy (P1, board AC #1)
- [ ] #8 Spec phase: User Story 3 — shipped severity channels: chronicle alert + map overlay (P2, reorient move-13 obligation)
