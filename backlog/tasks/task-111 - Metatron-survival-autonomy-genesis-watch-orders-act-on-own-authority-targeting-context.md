...
- [x] #3 miracle guidance includes live positions/passability; live invalid-target rejection rate measured and recorded via TASK-136 (amended 2026-07-27 per operator: record the data, not a ~0 gate — measured 80%, 8/10; binding constraint is model-side tool-call competence, not missing position context)
