...
- [[event-types-guardian-actions]] — Guardian miracle actions and gru events — time_snapped/item_granted/item_taken/entity_moved/entity_removed, `guardian.region_named` (spec 101), the gru emerged/moved/sighted/attacked/withdrew family.
