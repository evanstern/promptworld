...
func TestNightWarmthMechanics(t *testing.T) {
	...
	coldNight := decayNeeds(a0.Needs, false, true, false, false, false)
	day := decayNeeds(a0.Needs, false, false, false, false, false)
	...
	byFire := decayNeeds(Needs{Health: 1000, Food: 500, Rest: 500, Warmth: 500, Morale: 500},
		false, true, warmAt(s, a0.X, a0.Y, s.Tick), false, false)
