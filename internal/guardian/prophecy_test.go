...
func TestProphecyPromptSections(t *testing.T) {
	...
	base := turnUserPrompt(100, 1, 62, alive, nil, nil, nil, nil, nil, nil, nil, nil, "", "", "", "The player says:\nhello")
	...
	got := turnUserPrompt(100, 1, 62, alive, nil, nil, nil, prophecies, nil, nil, nil, nil, "", "", "", "The player says:\nhello")
