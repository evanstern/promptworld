...
func TestStageCeilingRosterTable(t *testing.T) {
	...
	cases := []struct {
		...
		{"stage-1", []string{"send_omen", "send_vision", "monitor_and_act", "cancel_order", "explain", "place_designation", "cancel_designation", "issue_directive", "cancel_directive", "survey_site", "prophesy", "brief_myths", "accept_mission", "note_mission_progress", "cancel_mission", "inspect_pack"}},
		{"stage-2", []string{"send_omen", "send_vision", "monitor_and_act", "cancel_order", "explain", "place_designation", "cancel_designation", "issue_directive", "cancel_directive", "survey_site", "prophesy", "brief_myths", "accept_mission", "note_mission_progress", "cancel_mission", "inspect_pack"}}, // stage-2 unlocks the charter, not tools
...
func TestStageOneInstructionLock(t *testing.T) {
	...
	if !reflect.DeepEqual(st.GrantedTools, []string{"send_omen", "send_vision", "monitor_and_act", "cancel_order", "explain", "place_designation", "cancel_designation", "issue_directive", "cancel_directive", "survey_site", "prophesy", "brief_myths", "accept_mission", "note_mission_progress", "cancel_mission", "inspect_pack"}) {
...
func TestCrossStageDeterminism(t *testing.T) {
	...
	if !reflect.DeepEqual(s1.granted, []string{"send_omen", "send_vision", "monitor_and_act", "cancel_order", "explain", "place_designation", "cancel_designation", "issue_directive", "cancel_directive", "survey_site", "prophesy", "brief_myths", "accept_mission", "note_mission_progress", "cancel_mission", "inspect_pack"}) {
