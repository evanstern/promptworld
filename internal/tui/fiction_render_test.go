...
func TestDefaultSkinRendersFictionFree(t *testing.T) {
	...
	fixtures := map[string]string{
		"guardian.nudged":             `{"form":"vision","targets":[0],"text":"beware"}`,
		"guardian.charge_regenerated": `{}`,
		"guardian.order_placed":       `{"id":"ord-1-0","origin":"player","condition":"c","action":"a","event_types":["agent.died"],"placed_tick":1,"expires_tick":90000,"status":"active"}`,
		"guardian.order_triggered":    `{"id":"ord-1-0","matched_type":"agent.died","matched_tick":5}`,
		"guardian.order_cancelled":    `{"id":"ord-1-0"}`,
		"guardian.order_expired":      `{"id":"ord-1-0"}`,
		"guardian.charter_observed":   `{"fingerprint":"ab12cd34ef56","default":true}`,
		"guardian.time_snapped":       `{"to_tick":106200,"gratis":false}`,
		"guardian.item_granted":       `{"agent":0,"kind":"food_raw","qty":2,"gratis":false}`,
		"guardian.entity_moved":       `{"class":"pile","x":3,"y":4,"to_x":6,"to_y":7,"gratis":false}`,
		"guardian.entity_removed":     `{"class":"pile","x":3,"y":4,"gratis":false}`,
		"guardian.place_revealed":     `{"agent":0,"facts":[{"kind":"fire","x":4,"y":5,"provenance":"revealed"}]}`,
